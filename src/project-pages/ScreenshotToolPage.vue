...
<template>
  <article class="capture-page">
    <section class="desktop-canvas">
      <ProjectImage class="wallpaper" :project="project" priority />
...
@media(max-width:900px){.desktop-canvas{height:auto;min-height:0;padding:100px 20px 120px}.selection{position:relative;inset:auto;min-height:420px}.selection-title{padding:26px 22px;width:100%}.selection-title h1{font-size:48px;line-height:1.1}.floating-tools{bottom:30px}}
</style>
