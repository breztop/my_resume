  ...
  <article class="scan-page">
    ...
    <section class="scan-hero">
      ...
      <figure class="scan-viewport">
        ...
        <figcaption><span>界面概念示意</span><strong>MATCH CANDIDATE</strong><i>示意</i></figcaption>
      </figure>

      <aside class="telemetry right-data" aria-hidden="true">
        <div class="dial"><span>—</span><small>界面示意</small></div>
        <p>TRACK ID<br />QUALITY<br />FRAME RATE<br />LATENCY</p>
...
@media(max-width:900px){.scan-hero{padding-top:35px}.hero-title h1{font-size:52px;line-height:1.1}}
</style>
